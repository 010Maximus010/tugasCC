...
@section('content')
                    ...
                    <div class="col-md-8 col-lg-6 vstack gap-4">
                        <div class="card">
                            <div class="card-body" style="margin-top: 0px;">
                                <h5 class="card-title" style="text-align: center;">Rekap Skripsi Mahasiswa Informatika</h5>
                                <br>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="table_rekap_skripsi">
    ...
    <script>
        $(document).ready(function() {
            $.ajax({
                url: '{{ route("rekap.dataSkripsi") }}',
                type: 'GET',
                success: function(response) {
                    var rekapDataSkripsi = response.rekap_data;
                    ...
                    var dataRow = "<tr>";
                    for (var year = 2017; year <= 2023; year++) {
                        dataRow += "<td><a href='" + generateLink('sudah', year) + "'>" + rekapDataSkripsi[year]['sudah'] + "</a></td>";
                        dataRow += "<td><a href='" + generateLink('belum', year) + "'>" + rekapDataSkripsi[year]['belum'] + "</a></td>";
                    }
                    dataRow += "</tr>";
        ...
        function generateLink(status, year) {
            ...
            var link = '{{ url("/list-skripsi") }}' + '/' + status + '/' + year;
            return link;
        }
    </script>
    <script>

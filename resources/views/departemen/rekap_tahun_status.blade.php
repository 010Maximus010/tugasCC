                    ...
                    <div class="col-md-8 col-lg-6 vstack gap-4">
                        <div class="card">
                            <div class="card-body" style="margin-top: 0px;">
                                ...
                                <h5 class="card-title" style="text-align: center;">Rekap Tahun {{ $tahun }} Berdasarkan Status: {{ $status }}</h5>
                                <br>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="table_rekap_status_tahun">

            ...
            <div class="row g-4">
                ...
                <div class="col-md-8 col-lg-6 vstack gap-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('edit_profile_departemen.update', $departemen->nim_nip) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                {{-- Form Nama --}}
                                <div class="row mt-1 mb-1">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama" value="{{ old('nama', $departemen->nama) }}" required>
                                    </div>
                                </div>

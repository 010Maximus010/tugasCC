                ...
                <div class="col-md-8 col-lg-6 vstack gap-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header d-sm-flex text-center align-items-center justify-content-between border-0 pb-0">
                            <a href="/departemen/progress_studi_mahasiswa" class="btn btn-sm btn-outline-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3 mt-2">
                                ...
                                <div class="col-10">
                                    <h6>Semester</h6>
                                    <a class="btn {{ $semester[1] }} avatar-xl mb-3 me-3 text-white" id="buttonModalProgress" data-bs-toggle="modal" data-bs-target="#progress_view" data-attr="{{ route('departemen_progress_detail_semester', ['nim' => $mahasiswa->nim, 'semester' => 1]) }}"><br />1</a>
                                    <a class="btn {{ $semester[2] }} avatar-xl mb-3 me-3 text-white" id="buttonModalProgress" data-bs-toggle="modal" data-bs-target="#progress_view" data-attr="{{ route('departemen_progress_detail_semester', ['nim' => $mahasiswa->nim, 'semester' => 2]) }}"><br />2</a>

                    ...
                    <div class="sidebar-body pt-5">
                        <div class="text-center">
                            ...
                            <div class="avatar avatar-xxl mt-n5 mb-1">
                                ...
                                <a href="#"><img class="avatar-img rounded-circle border border-4" style="border-color: #023047 !important;" src="{{ $mahasiswa->foto == null ? asset('assets/profil/default.jpg') : asset($mahasiswa->foto) }}" alt=""></a>

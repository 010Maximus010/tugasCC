...
<div class="modal fade" data-bs-backdrop="static" id="confirm_delete_khs" tabindex="-1" role="dialog" aria-labelledby="modalConfirmDeleteLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{ route('khs.destroy', [$item->semester_aktif, $item->nim]) }}" method="POST">
                @csrf
                @method('DELETE')
                <div class="modal-body">

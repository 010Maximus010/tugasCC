                ...
                <div class="col-md-8 col-lg-6 vstack gap-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header d-sm-flex text-center align-items-center justify-content-between border-0 pb-0">
                            <h1 class="card-title h5">Verifikasi Berkas PKL</h1>
                        </div>
                        <div class="card-body" style="margin-top: 0px;">
                            ...
                            <form action="{{ route('berkas_detail_pkl') }}" method="GET">
                                @csrf
                                <div class="row g-3">
                                    <div class="col-12">
                                            ...
                                            <table class="table table-bordered table-hover" id="table_1">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="cursor: pointer;">
                                                        ...
                                                        <td>
                                                            @if ($data->is_verifikasi_pkl == 1)
                                                                <span class="badge bg-success">Sudah diverifikasi</span>
                                                            @elseif ($data->is_verifikasi_pkl == 0)
